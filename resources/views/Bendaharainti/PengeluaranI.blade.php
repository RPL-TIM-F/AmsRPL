...
<nav class=" navbar navbar-expand navbar-white navbar-light">
     ...
     <!-- Tombol Add Pendapatan -->
      <div>
      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-Tambah">Add Pengeluaran</button>
      </div>
  </nav>
</div>
    ...
    <tbody>
      <tr>
        ...
        <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-Edit">
            ...
            <button type="button" class="btn btn-danger" name="delete" id="delete" href="#">Delete</button>
        </td>
      </tr>
      <tr>
        <td>2</td>
              ...
              <form role="form">
                <div class="card-body" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jumlah_pengeluaran" placeholder="Jumlah">
                  </div>
                  <div class="form-group">
