                    ...
                    <form action="/pengeluaraninti/store" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="proker" placeholder="Nama Proker" name="proker">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tanggal_pengeluaran" placeholder="Tanggal Pengeluaran" name="tanggal_pengeluaran">
                            </div>
